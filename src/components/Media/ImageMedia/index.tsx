...
export function ImageMedia(props: MediaProps): React.JSX.Element {
	let width: number | undefined
	let height: number | undefined
	let alt = props.alt
	let src: StaticImageData | string = props.src || ''
	...
	const loading = props.loading || (!props.priority ? 'lazy' : undefined)
	...
	return (
		<picture className={cn(props.pictureClassName)}>
			<NextImage
				alt={alt || ''}
				className={cn(props.imgClassName)}
				fill={props.fill}
